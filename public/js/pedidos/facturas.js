            ...
            detallefactura.forEach(element => {
                ...
                $.ajax(settings).done(function (response) {
                    $.each(response[0], function (key, val) {
                        stock = parseInt(val.STOCK) - parseInt(cantidad)
                        var settings = {
...
function agregar_detalle(cod_producto, producto, cantidad, precio, envio, total) {
...
function agregar() {
    ...
    if (stock <= cantidad) {
        ...
        var fila = "<tr><td>" + producto + "</td><td>" + detalle + "</td><td>" + cantidad + "</td><td>" + precio + "</td><td>" + costo_envio + "</td><td class='subtotal'>" + subtotal + "</td></tr>";
        $("#FSUbTotal").val(subtotal)
        var btn = document.createElement("TR");
        btn.innerHTML = fila;
        document.getElementById("contenido_detalle").appendChild(btn);
        var data = [];
        ...
        $("#FEnvio").val("")
        $("#FSKU").val("");
        agregar_detalle(Cod_producto, producto, cantidad, precio, costo_envio, subtotal)
