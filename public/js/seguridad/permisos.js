...
Modulo_Usuario = localStorage.getItem("mostrar_modulo_usuario");
rol_logeado = localStorage.getItem("rol");
...
function permisos_roles() {
    ...
    url_roles = api + "permisos/roles";
    myHeader.append("Content-Type", "application/json",);
    var raw = JSON.stringify({ "ROL": rol_logeado });
    var requestOptions = {
        method: 'POST',
        headers: myHeader,
        body: raw,
    ...
    fetch(url_roles, requestOptions)
        ...
        .then(function (data) {
            ...
            data[0].forEach(rol => {
                ...
                } if (rol.LEER == 0 && rol.COD_MODULO == 10) {
                ...
                if (rol.CREAR == 1 && rol.COD_MODULO == 13) {
                ...
                if (rol.MODIFICAR == 0 && rol.COD_MODULO == 13) {
                ...
                if (rol.ELIMINAR == 0 && rol.COD_MODULO == 13) {
