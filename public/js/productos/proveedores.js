    ...
    $("#registro_proveedor").click(function () {
        ...
        $.ajax(settings).done(function (response) {
            if (response.message) {
                ...
                $("#RNom_proveedor").val("");
                $("#RCorreo_proveedor").val("");
                $("#Rdireccion_proveedor").val("");
                $("#RTelefono_proveedor").val("");
                    ...
                    customize: function (doc) {
                        doc.content.splice(1, 0, {
                            columns: [{
                                ...
                                margin: [0, 5],
                                text: 'REPORTE DE PROVEEDORES***** GENERADO POR: ' + user_logeado,
                                alignment:'justify',
                                fontSize: 12
                            }]
                        });
...
function cancelar_actu_proveedor() {
    $("#ANom_proveedor").val("");
   $("#ACorreo_proveedor").val("");
   $("#Adireccion_proveedor").val("");
    $("#ATelefono_proveedor").val("");
    ...
    fetch(url_actualizar_permisos, requestOptions)
        ...
        .then(result => {
            ...
            if (result) {
                ...
                document.frm_categoria.submit();
                document.getElementById("actualizar_proveedor").style.display = "none"
                document.getElementById("alerta_proveedores").style.display = "none"
                document.getElementById("proveedores_sistema").style.display = "block"
            }
        })
