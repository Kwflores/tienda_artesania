...
function cargar_usuarios() {
    ...
    $.ajax(settings).done(function (response) {
        ...
        activar_usuario("#table_id tbody", table_usuarios);
        obtener_data_cod_user("#table_id tbody", table_usuarios);
        obtener_data_cambiar_clave("#table_id tbody", table_usuarios);
