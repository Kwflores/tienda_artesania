...
function cargar_usuarios() {
    ...
    $.ajax(settings).done(function (response) {
        ...
        $.each(response[0], function (key, val) {
            ...
            editar = "<button type='input' class='editar btn btn-success'  data-toggle='tooltip' data-placement='left' title='Editar Datos de Usuario'><i class='fas fa-pencil-alt' aria-hidden='true'></i> <button type='input' class='contraseña btn btn-warning' data-toggle='tooltip' data-placement='left' title='Cambiar Contraseña'><i class='fa fa-unlock-alt' aria-hidden='true'></i>"
...
function actualizar_datos() {
    ...
    myHeader.append("Content-Type", "application/json",);
    var raw = JSON.stringify({ "COD_PERSONA":persona, "NOM_PERSONA":cliente, "USER_EMAIL":correo, "NUM_CEL":telefono, "NOM_USUARIO":usuario, 
...
url_actualizar_usuarios= api + "usuarios/actualizar";
myHeader.append("Content-Type", "application/json",);
var raw = JSON.stringify({ "COD_PERSONA":persona.innerHTML, "NOM_PERSONA":nombre, "USER_EMAIL":correo, "NUM_CEL":telefono, "NOM_USUARIO":usuario, 
"NOM_IDENTIFICACION":idenficacion, "COD_IDENTIFICACION":no_identificacion, 
